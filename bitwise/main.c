...
void checkLinuxPermissions(unsigned char linuxPermission){
    decorate();
    printf("linux permission in binary 0b%b\n", linuxPermission);

    printf("This user can read %b\n", (linuxPermission & LINUX_READ_PERMISSION) ==  LINUX_READ_PERMISSION);
    printf("This user can write %b\n", (linuxPermission & LINUX_WRITE_PERMISSION) == LINUX_WRITE_PERMISSION);
    printf("This user can execute %b\n", (linuxPermission & LINUX_EXECUTE_PERMISSION) == LINUX_EXECUTE_PERMISSION);
    // 100 & 111 = 100
    decorate();
}
